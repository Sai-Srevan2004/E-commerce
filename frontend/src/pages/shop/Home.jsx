...
function HomePage() {
  ...
  const { products, singleProductDetails } = useSelector(
  ...
  function handleNavigateToListingPage(getCurrentItem, section) {
      navigate(`/shop/products?${section}=${getCurrentItem.id}`);
  }

  function handleGetProductDetails(getCurrentProductId) {
    dispatch(fetchProductDetails(getCurrentProductId)).then((data)=>{
      console.log(data,"signle producr details")
    });
  }
  ...
  useEffect(() => {
    dispatch(getFeatureImages()).then((action)=>{
      console.log(action,"zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz")
    });
  }, [dispatch]);
